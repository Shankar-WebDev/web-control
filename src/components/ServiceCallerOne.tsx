...
const ServiceCaller: React.FC = () => {
  ...
  const BASE_URL = `http://localhost:4500`; // Change this base URL as needed
  ...
  const buttons = [
    ...
    {
      name: 'Kill',
      endpoint: `${BASE_URL}/kill`,
      payload: killPayload('turtle1'),
    },

    {
      name: 'Start System',
      endpoint: `${BASE_URL}/nodelauncher`,
      payload: nodeLauncherPayload('start', 1),
    },
    {
      name: 'Stop System',
      endpoint: `${BASE_URL}/nodelauncher`,
      payload: nodeLauncherPayload('start', 0),
    },
    {
      name: 'Start motor',
      endpoint: `${BASE_URL}/nodelauncher`,
      payload: nodeLauncherPayload('motor', 1),
    },
    {
      name: 'Stop motor',
      endpoint: `${BASE_URL}/nodelauncher`,
      payload: nodeLauncherPayload('motor', 0),
    },
    {
      name: 'Initiate Teleop',
      endpoint: `${BASE_URL}/nodelauncher`,
      payload: nodeLauncherPayload('teleop', 1),
    },
    {
      name: 'Stop Teleop',
      endpoint: `${BASE_URL}/nodelauncher`,
      payload: nodeLauncherPayload('teleop', 0),
    },
    {
      name: 'Start Mapping',
      endpoint: `${BASE_URL}/nodelauncher`,
      payload: nodeLauncherPayload('map', 1),
    },
    {
      name: 'Stop Mapping',
      endpoint: `${BASE_URL}/nodelauncher`,
      payload: nodeLauncherPayload('map', 0),
    },
    {
      name: 'Start Navigation',
      endpoint: `${BASE_URL}/nodelauncher`,
      payload: nodeLauncherPayload('nav', 1),
    },
    {
      name: 'Stop Navigation',
      endpoint: `${BASE_URL}/nodelauncher`,
      payload: nodeLauncherPayload('nav', 0),
    },
    ...
    {
      name: 'add 2+5',
      endpoint: `${BASE_URL}/add_two_ints`,
      payload: addTwoIntsPayload(BigInt(2), BigInt(5)),
    },
    {
      name: 'add 4+8',
      endpoint: `${BASE_URL}/add_two_ints`,
      payload: addTwoIntsPayload(BigInt(4), BigInt(8)),
    },
    {
      name: 'add 290+5',
      endpoint: `${BASE_URL}/add_two_ints`,
      payload: addTwoIntsPayload(BigInt(290), BigInt(5)),
    },
    {
      name: 'add 400+8',
      endpoint: `${BASE_URL}/add_two_ints`,
      payload: addTwoIntsPayload(BigInt(400), BigInt(8)),
    },
    {
      name: 'add 8002+5',
      endpoint: `${BASE_URL}/add_two_ints`,
      payload: addTwoIntsPayload(BigInt(8002), BigInt(5)),
    },
    {
      name: 'add 480+8',
      endpoint: `${BASE_URL}/add_two_ints`,
      payload: addTwoIntsPayload(BigInt(480), BigInt(8)),
    },
  ];
  ...
  const handleResponse = (key: string, value: any) => {
    ...
    if (key === 'add_two_ints') {
      console.log(
        new CdrReader(convertOctetToUint8Array(value)).int64(),
        ' <-- this is the result'
      );
    }
  ...
  return (
    <div className="bg-white shadow-md rounded-lg mb-4">
      <header className="bg-blue-500 text-white p-4">
        <h5 id="panel_label" className="text-lg font-semibold m-0">
          Action Panel
        </h5>
      </header>
